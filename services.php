		...
		<div class="main-page-wrapper theme-bg-color">
							...
							<nav class="navbar float-right">
							   ...
							   <div class="collapse navbar-collapse" id="navbar-collapse-1">
							     <ul class="nav navbar-nav">
							       ...
							       <li class="current-page-item"><a href="services.php">SERVICES</a></>
			...
			<div class="inner-page-banner">
				<div class="opacity">
					<div class="container">
						<h2>What We Offer</h2>
						<p>Cloud Advisory & Optimization Implementation & Migration Management & Automation Security & Governance</p>
					</div> <!-- /.container -->
				</div> <!-- /.opacity -->
        ...
        <div class="container">
            <div class="row">
                <div class="course-item-wrapper">
                    ...
                    $sql = "SELECT id, name, description, image FROM Service";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '</div>';
        echo '<div class="text">';
        echo '<h4><a href="services-details.php?id='.$row["id"].'">'.$row["name"].'</a></h4>';
        echo '<p>'.$description.'</p>';
        echo '<div class="clear-fix">';
        echo '<a href="services-details.php?id='.$row["id"].'" class="tran3s p-color-bg themehover">More</a>';
        echo '</div>';
        echo '</div>'; // /.text
        echo '</div>';
        echo '</div>'; // /.item
