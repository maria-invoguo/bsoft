							...
							<nav class="navbar float-right">
							   ...
							   <div class="collapse navbar-collapse" id="navbar-collapse-1">
							     <ul class="nav navbar-nav">
							       ...
							       <li class="current-page-item"><a href="services.php">SERVICES</a></li>
			        		...
			        		<div class="course-item-wrapper">
			        			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
			        				<div class="hvr-float-shadow single-course-item">
				        				<div class="img-holder"><img src="images/inner-page/13.jpg" alt="Image"></div>
				        				<div class="text">
				        					<h4><a href="services-details.php">web development courses</a></h4>
				        					
				        					<p>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat</p>
				        					<div class="clear-fix">

				        						<a href="services-details.php" class="tran3s p-color-bg themehover">More</a>
				        					</div>
				        				</div> <!-- /.text -->
			        				</div>
			        			</div> <!-- /.item -->
			        			...
			        			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
			        				<div class="hvr-float-shadow single-course-item">
				        				...
				        				<div class="text">
				        					<h4><a href="services-details.php">Learn Basic German Fast</a></h4>
			        			...
			        			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
			        				<div class="hvr-float-shadow single-course-item">
				        				...
				        				<div class="text">
				        					<h4><a href="services-details.php">basic time use properly</a></h4>
			        			...
			        			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
			        				<div class="hvr-float-shadow single-course-item">
				        				<div class="img-holder"><img src="images/inner-page/14.jpg" alt="Image"></div>
				        				<div class="text">
				        					<h4><a href="services-details.php">Learn Basic German Fast</a></h4>
			        			...
			        			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
			        				<div class="hvr-float-shadow single-course-item">
				        				<div class="img-holder"><img src="images/inner-page/15.jpg" alt="Image"></div>
				        				<div class="text">
				        					<h4><a href="services-details.php">basic time use properly</a></h4>
