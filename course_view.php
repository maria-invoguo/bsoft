      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="row mb-3">
              <div class="col">
                <h5 class="card-title float-start">Course Table</h5>
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if (strlen($row['description']) > 100) {
                        echo '<a href="course_edit.php?id=' . $row['id'] . '" style="color: #FB0E7D;">&nbsp;&nbsp;&nbsp;See more..</a>';
                      }
                      ?>
                    </td>
                    <td><?php echo $row['status']; ?></td>
                    <td>
                      <button class="btn btn-dark" style="width: 80px; height: 35px; border-radius: 5px; color: white;" onclick="window.location.href='course_edit.php?id=<?php echo $row['id']; ?>'">Edit</button>
                    </td>
                    <td>
                      <button class="btn btn-danger" style="width: 80px; height: 35px; border-radius: 5px; color: white;" onclick="window.location.href='course_delete.php?id=<?php echo $row['id']; ?>'">Delete</button>
                    </td>
                  </tr>
                  <?php
                }
...
<script>
  document.getElementById('searchInput').addEventListener('input', function() {
    ...
    rows.forEach(row => {
      var place = row.cells[3].textContent.toLowerCase();
