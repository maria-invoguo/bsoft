							...
							<nav class="navbar float-right">
							   ...
							   <div class="collapse navbar-collapse" id="navbar-collapse-1">
							     <ul class="nav navbar-nav">
							       ...
							       <li class="current-page-item"><a href="about.php">About Us</a></li>
...
$sql = "SELECT id, name FROM Course"; // Assuming you have a table named 'courses' with columns 'id' and 'course_name'
$result = $conn->query($sql);

$course_ids = [];
if ($result->num_rows > 0) {
    // Store course IDs in an array
...
<div class="theme-manage-area">
    <div class="container">
        <div class="item-part float-left item1 p-color-bg">
            <h3><i class="fa fa-graduation-cap" aria-hidden="true"></i>Our Vision</h3>
            <p>To improve life through learning and providing the best IT training services for people from all walks of life.</p>
            <?php if (!empty($course_ids)) : ?>
                <a href="course.php?id=<?php echo $course_ids[0]['id']; ?>" class="tran3s">Read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
            <?php endif; ?>
        </div>
        ...
        <div class="item-part float-left item1 p-color-bg">
            <h3><i class="fa fa-book" aria-hidden="true"></i>Our Mission</h3>
            <p>Empowering individuals with cutting-edge IT skills through accessible, high-quality training programs that foster lifelong learning and career growth.</p>
            <?php if (!empty($course_ids) && isset($course_ids[1])) : ?>
                <a href="course.php?id=<?php echo $course_ids[1]['id']; ?>" class="tran3s">Read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
            <?php endif; ?>
        </div>
    </div> <!-- /.container -->
	        ...
	        <div class="welcome-section" style="margin-top:100px !important;">
	        	<div class="container">
	        		<div class="section-title wow fadeInUp">
	        			<h2 class="p-color">Welcome to BSOFT</h2>
	        			<h5>awesome success with student</h5>
	        			<p>Bsoft is a leading Training and Placement Center in Kerala & Bangalore managed by MNC Experts with more than a decade of experience in leading MNC companies.
							We are known for our practical approach towards training that enables students to gain real-time exposure on competitive technologies.  </p>
	        		</div> <!-- /.section-title -->

	        		<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInUp">
	        				<h3><i class="fa fa-graduation-cap" aria-hidden="true"></i> OUR COURSE TRACKS</h3>
	        				<p>We provide training for signature certifications from Cisco,
								 PaloAlto, CheckPoint, Fortinet, F5, AWS, Microsoft, CEH  AI, Data Science,Comptia, 
								 Checkpoint,Redhat, Python, and PenTest that offer highest level of accreditation in industry.
								  You may choose to pursue any of the following modules although it is recommended
								   that you go in accordance with the level scale of beginner to expert. </p>
	        			</div>
	        			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInUp">
	        				<h3><i class="fa fa-tags" aria-hidden="true"></i> 120+ Courses available</h3>
	        				<p>Training with Placement Assistance
                                Training on Top IT certifications.
								<br>
                                2- 12 Months of training
                                Classroom / Online
                               Real Time Virtual Lab.
							   <br>
							   Free Demo Class-Join our training with confidence.
							    Attend a free demo class( Online&Offline) to experience our
								 expert trainers and get all your queries answered.</p>
	        			</div>
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInUp">
	        				<h3><i class="fa fa-diamond" aria-hidden="true"></i> Everything you need</h3>
	        				<p>Beginner & Advanced level Classes.
								<br>
                              Hands-On Learning .
							  <br>
                              Best Practice for interview Preparation Techniques .
							  <br>
                              Lifetime Access for Student’s Portal, Study Materials, Videos & Top MNC Interview Questions.
							  <br>
                              Affordable Fees with Best curriculum Designed by Industrial  Experts.
							  <br>
                              Delivered by 10+ years of Certified Experts. </p>
	        			</div>
	        		</div>
	        	</div> <!-- /.container -->
	        </div> <!-- /.welcome-section -->
