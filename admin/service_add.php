    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Added Services will display on the website</h5>
...
if(isset($_POST['submit'])) {
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO Service (image, name, description, status) 
                    VALUES ('$image_name', '$name', '$description', '$status')";
